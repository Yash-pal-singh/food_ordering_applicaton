  ...
  return (
      ...
      <div className='py-12'>
        ...
        <div className='flex gap-4  text-sm'>
          <button className='flex items-center justify-center gap-2 uppercase bg-primary text-white px-4 py-2 rounded-full'>Order now
          <Right/>
          </button>
        ...
        style={{objectFit:'contain'}} alt={'pizza'}/>
        </div>
      </section>
  )
}
